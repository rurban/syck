...
Gem::Specification.new do |s|
  ...
  s.authors = ["Reini Urban", "Hiroshi SHIBATA", "Aaron Patterson", "Mat Brown"]
  s.email = ["rurban@cpan.org", "hsbt@ruby-lang.org", "aaron@tenderlovemaking.com"]
  s.homepage = "https://github.com/rurban/syck"
  s.license = "MIT"
  s.require_paths = ["lib"]
