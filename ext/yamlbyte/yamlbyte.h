...
#define YAMLBYTE_SEQUENCE ((yamlbyte_char_t)'S')
...
typedef yamlbyte_result_t (*yamlbyte_push_t)(yamlbyte_consumer_t self,
...
typedef yamlbyte_result_t (*yamlbyte_pushbuff_t)(yamlbyte_consumer_t self,
