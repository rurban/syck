...
#ifdef DEBUG
__attribute__noreturn__ void syck_assert(const char *file_name,
                                         unsigned line_num);
#define ASSERT(f)                                                              \
  if (!f)                                                                      \
 ...
 * Handler prototypes
 */
EXPORT __attribute__warn_unused_result__ SYMID syck_hdlr_add_node(SyckParser *p,
                                                                  SyckNode *n);
EXPORT __attribute__warn_unused_result__ SyckNode *
syck_hdlr_add_anchor(SyckParser *p, char *a, SyckNode *n);
EXPORT void syck_hdlr_remove_anchor(SyckParser *p, char *a);
EXPORT
__attribute__warn_unused_result__ __attribute__returns_nonnull__ SyckNode *
syck_hdlr_get_anchor(SyckParser *p, char *a);
EXPORT void syck_add_transfer(char *uri, SyckNode *n, int taguri);
EXPORT __attribute__warn_unused_result__ char *
syck_xprivate(const char *type_id, int type_len);
EXPORT __attribute__malloc__ __attribute__warn_unused_result__ char *
syck_taguri(const char *domain, const char *type_id, int type_len);
EXPORT __attribute__warn_unused_result__ int syck_tagcmp(const char *tag1,
                                                         const char *tag2);
EXPORT int syck_add_sym(SyckParser *p, void *data);
EXPORT int syck_lookup_sym(SyckParser *p, SYMID, char **out);
EXPORT __attribute__warn_unused_result__ int syck_try_implicit(SyckNode *n);
EXPORT __attribute__warn_unused_result__ char *
...
EXPORT __attribute__warn_unused_result__
    __attribute__returns_nonnull__ const char *
...
EXPORT long syck_io_file_read(char *buf, SyckIoFile *file, long max_size,
                              long skip);
EXPORT __attribute__warn_unused_result__ long
syck_io_str_read(char *buf, SyckIoStr *str, long max_size, long skip);
EXPORT __attribute__warn_unused_result__ char *syck_base64enc(char *, long);
EXPORT __attribute__warn_unused_result__ char *syck_base64dec(char *, long,
                                                              long *);
EXPORT __attribute__malloc__ __attribute__warn_unused_result__
    __attribute__returns_nonnull__ SyckEmitter *
    syck_new_emitter(void);
EXPORT void syck_emitter_permit_duplicate_refs(SyckEmitter *e, int);
EXPORT __attribute__warn_unused_result__ SYMID
syck_emitter_mark_node(SyckEmitter *e, st_data_t);
...
EXPORT void syck_emit_scalar(SyckEmitter *e, const char *,
                             enum scalar_style force_style, int, int, char,
                             const char *, long);
...
EXPORT
__attribute__warn_unused_result__ __attribute__returns_nonnull__ SyckLevel *
...
EXPORT __attribute__malloc__ __attribute__warn_unused_result__
    __attribute__returns_nonnull__ SyckParser *
...
__attribute__warn_unused_result__ int syck_scan_scalar(int, const char *, long);
...
EXPORT void syck_parser_set_input_type(SyckParser *p,
                                       enum syck_parser_input input_type);
...
EXPORT __attribute__returns_nonnull__ SyckLevel *
 ...
 */
EXPORT __attribute__malloc__ SyckNode *syck_alloc_map(void);
EXPORT __attribute__malloc__ SyckNode *syck_alloc_seq(void);
EXPORT __attribute__malloc__ SyckNode *syck_alloc_str(void);
EXPORT __attribute__warn_unused_result__
    __attribute__returns_nonnull__ const char *
    syck_node_kind(SyckNode *n);
...
EXPORT __attribute__malloc__ __attribute__warn_unused_result__ SyckNode *
...
EXPORT void syck_replace_str2(SyckNode *n, char *str, long len,
                              enum scalar_style style);
EXPORT void syck_str_blow_away_commas(SyckNode *n);
#ifdef HAVE_RUBY_ST_H
EXPORT int syck_st_free_nodes(st_data_t key, st_data_t record, st_data_t arg);
#else
EXPORT enum st_retval syck_st_free_nodes(SHIM(const char *key), void *record,
                                         SHIM(void *arg));
#endif
