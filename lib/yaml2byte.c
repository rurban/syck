...
static bytestring_t *bytestring_alloc(void) {
  bytestring_t *ret;
...
static void bytestring_append(bytestring_t *str, char code, const char *start,
                              const char *finish) {
  long grow;
...
static void bytestring_extend(bytestring_t *str, bytestring_t *ext) {
  char *from;
  char *curr;
  char *stop;
  long grow;
